...
$(function () {
    ...
    $('#uploadForm').submit(function () {
        ...
        xhr.open('post', '/api/upload/?currentPath='+spcp, true);
    ...
    var menu1 = [
        {'새 폴더':function(menuItem,menu) {
            ...
            if (modal.valueOf()==null){
                ...
                var spcp = currentPath.substr(6);
                xhr.overrideMimeType('application/json');
                xhr.open('post', '/api/mkdir/?currentPath='+spcp+'&folderName='+modal, true);
                xhr.send();
                location.reload(true);
            }
        } }
    ...
    var menu2 = [
        ...
        {'이름 바꾸기': function(menuItem,menu) {
            ...
            if (modal.valueOf()==null){
                ...
                xhr.overrideMimeType('application/json');
                xhr.open('post', '/api/rndir/?currentPath='+spcp+'&folderName='+modal+'&originalName='+opcp, true);
                xhr.send();
                location.reload(true);
            }
        } },
        ...
        {'삭제':function(menuItem,menu) {
            ...
            if (modal==true){
                ...
                var opcp = originaldir.substr(6);
                xhr.overrideMimeType('application/json');
                xhr.open('post', '/api/unlink/?originalName='+opcp, true);
                xhr.send();
                location.reload(true);
            }
        } }
